...
function DashBoardComp() {
    ...
    useEffect(() => {
        const fetchUsers = async () => {
            try {
                const res = await fetch(`https://blog-website-backend-cyan.vercel.app/api/post/getusers?limit=5`,
                    {
                        method: "GET",
                        headers: {
        ...
        const fetchPosts = async () => {
            try {
                const res = await fetch(`https://blog-website-backend-cyan.vercel.app/api/post/getposts?limit=5`,
                    {
                        method: "GET",
                        headers: {
                            "Content-Type": "application/json",
        ...
        const fetchComments = async () => {
            try {
                const res = await fetch('https://blog-website-backend-cyan.vercel.app/api/comment/getcomments?limit=5',
                    {
                        method: "GET",
                        headers: {
                            "Content-Type": "application/json",
