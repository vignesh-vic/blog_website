...
function DashComment() {
        ...
        const fetchComments = async () => {
            try {
                const res = await fetch(
                    `https://blog-website-bay-psi.vercel.app//api/comment/getcomments`, {
                    method: "GET",
                    headers: {
    ...
    const handleShowMore = async () => {
        ...
        try {
            const res = await fetch(`https://blog-website-bay-psi.vercel.app//api/comment/getcomments?startIndex=${startIndex}`, {
                method: "GET",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`
    ...
    const handleDeleteComment = async () => {
        setShowModel(false)
        try {
            const res = await fetch(`https://blog-website-bay-psi.vercel.app//api/comment/deleteComment/${commentIdToDelete}`, {
                method: "DELETE",
                headers: {
                    "Content-Type": "application/json",
                    Authorization: `Bearer ${token}`
