...
export default function Search() {
    ...
    useEffect(() => {
        ...
        const fetchPosts = async () => {
            ...
            const res = await fetch(`https://blog-website-woad-mu.vercel.app/api/post/getposts?${searchQuery}`)
            if (!res.ok) {
                setLoading(false)
                return
            }
            ...
            <div className='w-full'>
                ...
                <div className='p-7 flex flex-wrap gap-4'>
                    ...
                    }
                    {
                        ...
                        showMore && <button className='text-teal-500 hover:underline p-7 w-full'
                            onClick={handleClick}
                        >
                            Show More
                        </button>
